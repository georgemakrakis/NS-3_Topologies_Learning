//#include "EmulatedTCP_neighborhood.h"
...
NS_LOG_COMPONENT_DEFINE("EmulatedTCP_neighborhood");
...
{
    LogComponentEnable ("EmulatedTCP_neighborhood", LOG_LEVEL_ALL);
    ...
    // Enable the neighborhood networl capture as well
    AsciiTraceHelper ascii;
    csma.EnableAsciiAll(ascii.CreateFileStream("neighborhood_TCP"));
    csma.EnablePcapAll("neighborhood_TCP", true);
