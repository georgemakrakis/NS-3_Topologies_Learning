...
// THIS SCRIPT IS A COPY OF THE EmulatedUdpEchoExample BUT I HAVE CHANGED ONLY THE INTERFACE NAME
// AND ADDED THE CREATION OF VIRTUAL INTERFACES SO IT CAN COMMUNICATE WITH A NETCAT UDP SERVER

//#include "EmulatedUdpEchoExample_Copy.h"
...
NS_LOG_COMPONENT_DEFINE("EmulatedUdpEchoExample_Copy");
